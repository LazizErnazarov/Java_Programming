...
public class PolymorphismPractice3 {
    ...
    public static void main(String[] args) {
        ...
        //2. How many developers,Testers,Teachers,Drivers do we have?
        ...
        System.out.println("countDev = " + countDeveloper);
        System.out.println("countTest = " + countTester);
        System.out.println("countTeach = " + countTeacher);
        System.out.println("countDr = " + countDriver);
